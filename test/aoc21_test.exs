defmodule Aoc21Test do
  ...
  test "Day Ten" do
    assert Aoc21.DayTen.part_one() == 266_301
    assert Aoc21.DayTen.part_two() == 3_404_870_164
  end

  test "Day Eleven" do
    assert Aoc21.DayEleven.part_one() == 1702
    assert Aoc21.DayEleven.part_two() == 251
  end

  test "Day Twelve" do
    assert Aoc21.DayTwelve.part_one() == 3497
    assert Aoc21.DayTwelve.part_two() == 93686
  end
end
